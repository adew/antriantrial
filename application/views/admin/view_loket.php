        ...
        <div class="page-wrapper">
          ...
          <div class="row page-titles">
            <div class="col-md-5 align-self-center">
              <h3 class="text-primary">Data Loket</h3>
            </div>
          </div>
          <!-- End Bread crumb -->
          <!-- Container fluid  -->
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td><a href="javascript:void(0)" class="btn btn-sm btn-danger" onclick="delete_loket(<?= $data['loket_id']; ?>)">Delete</a>
                                <a href="javascript:void(0)" class="btn btn-sm btn-warning" onclick="edit_loket(<?= $data['loket_id']; ?>)">Edit</a>
                              </td>
                            </tr>
                          <?php } ?>
